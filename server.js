...
app.get('/to-do', checkAuthenticated, (req, res) => {
  res.render('to-do.ejs', { name: req.user.name })
})

app.get('/flashcards', checkAuthenticated, (req, res) => {
  res.render('flashcards.ejs', { name: req.user.name })
})

app.get('/classes', checkAuthenticated, (req, res) => {
  res.render('classes.ejs', { name: req.user.name })
})

app.get('/schedule', checkAuthenticated, (req, res) => {
  res.render('schedule.ejs', { name: req.user.name })
})
